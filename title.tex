...
\newcommand{\DelTitle}{Pilots development – collaborative methodology and tools}
\newcommand{\DelNumber}{D1.3}
\newcommand{\DelVersion}{V0.5}
...
\begin{tabular}{|l|p{125mm}|}\hline
  \multicolumn{2}{|c|}{\textbf{Deliverable information}}\\\hline
    ...
    Lead beneficiary & CNRS \\\hline
    Contributors & OU, UNIBO, KCL, NUI GALWAY, NISV, CNAM, KNAW \\\hline
    Document status & Draft (Univer review, Final) \\\hline
    Document version & \DelVersion \\\hline
  Date& \today \\\hline
  Authors&
  \begin{tabular}[t]{l}
    Enrico Daga, The Open University (OU) \\
    Albert Mero\`no (KCL) \\
    Marilena Daquino (UNIBO) \\
    Elena Musumeci (UNIBO) \\
    Marco Guerrieri (CNRS)
  \end{tabular}\\\hline
  Peer review&
  \begin{tabular}[t]{l}
  Andrea Nuzzolese (UNIBO)\\
  Rocco Tripodi (UNIBO)
\end{tabular}\\\hline
\end{tabular}
...
\begin{tabular}{|l|l|p{5.5cm}|p{5.5cm}|}\hline
  ...
  V0.5 & 20/05/2021 & Prepared for internal review & Enrico Daga (OU) \\\hline  
  & & & \\\hline  
  \end{tabular}
